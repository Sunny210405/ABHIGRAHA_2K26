/**
 * Cloudflare Pages & Workers Full-Stack Entry Point: _worker.js
 * Enables Worker runtime for Cloudflare to unlock KV Bindings.
 * Handles /api/content for real-time festival management and serves static assets.
 */
